...
export class AngularJsAdapter extends Adapter implements AdapterInterface {
  ...
  getDependencyInjections(target: any): Array<string> {
    if (target === null) {
      ...
      let dependencyInjections: Array<string> = this.getDependencyInjections(
        target.__proto__
      );
      if (
    ...
    return (declaration: ComponentDeclarationType): Function => {
      return (target: Function): any => {
        ...
        if (indexOf < 0) {
          ...
          declaration.bindings = this.mergeBindings(
        ...
        if (typeof target === "function") {
          ...
          if (typeof identifier === "string" && identifier.length > 0) {
            ...
            if (indexOf < 0) {
              ...
              this.warn(
                `Multiple injectable identifier '${identifier}' =/= '${
                  this.injectables[indexOf]
                }'.`
              );
            }
          } else {
