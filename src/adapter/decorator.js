...
export class AdapterDecorator {
  ...
  inject(): Function {
    return(identifier: string): Function => {
      return (target: Function, property: any, descriptor: any): any => { // eslint-disable-line no-unused-vars
  ...
  pipe(): Function {
    return(declaration: PipeDeclarationType): Function => {
      return (target: Function): any => {
        return adapter.pipe(target, declaration);
      }
    }
  }
