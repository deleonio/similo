...
function getInjects(injector: Injector, injects: string[]): any[] {
  let services: any[] = [];
  injects.forEach((inject: string) => {
    services.push(injector.get(inject));
  });
  return services;
}
...
function filterDataAndMethods(object: Object, bindings: any[], data: Object = {}, methods: Object = {}): Object {
